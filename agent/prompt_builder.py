...
KANBAN_GUIDANCE = (
    ...
    "8. **Verified recovery attempt.** When a scoped failure occurs, first "
    "deterministically reproduce it, then apply the smallest in-scope reversible "
    "repair, and verify it with risk-based tests or read-back. Make at most one "
    "bounded repair attempt during the run; if the failure persists or requires "
    "scope expansion, roll back unverified changes and block with the concrete reason.\n"
    "\n"
    "## Orchestrator mode\n"
    "\n"
